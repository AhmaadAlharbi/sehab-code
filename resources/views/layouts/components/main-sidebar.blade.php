							...
							<ul class="main-menu">
								...
								<li class="slide has-sub">
									...
									<ul class="slide-menu child1">
										...
										<li class="slide">
											<a href="{{url('widget-notification')}}" class="side-menu__item">Widget-notification</a>
										</li>
										<li class="slide">
										...
										<li class="slide has-sub">
											...
											<ul class="slide-menu child2">
												...
												<li class="slide">
													<a href="{{url('file-manager-list')}}" class="side-menu__item">File-Manager-List</a>
												</li>
												<li class="slide">
													<a href="{{url('file-manager-details')}}" class="side-menu__item">File-Manager-details</a>
												</li>
											</ul>
										</li>
									</ul>
								...
								<li class="slide has-sub">
									...
									<ul class="slide-menu child1 mega-menu">
										...
										<li class="slide">
											<a href="{{url('navs-tabs')}}" class="side-menu__item">Tabs</a>
										</li>
										<li class="slide">
								...
								<li class="slide has-sub">
									...
									<ul class="slide-menu child1">
										...
										<li class="slide">
											<a href="{{url('editprofile')}}" class="side-menu__item">Edit-Profile</a>
										</li>
										<li class="slide">
											<a href="{{url('about')}}" class="side-menu__item">About-Us</a>
										</li>
										<li class="slide">
										...
										<li class="slide">
											<a href="{{url('todotask')}}" class="side-menu__item">Todotask</a>
										</li>
										<li class="slide">
										...
										<li class="slide has-sub">
											...
											<ul class="slide-menu child2">
												<li class="slide">
													<a href="{{url('signin')}}" class="side-menu__item">Sign In</a>
												</li>
												<li class="slide">
													<a href="{{url('signup')}}" class="side-menu__item">Sign Up</a>
												</li>
												<li class="slide">
													<a href="{{url('forgot')}}" class="side-menu__item">Forgot Password</a>
												</li>
												<li class="slide">
													<a href="{{url('reset')}}" class="side-menu__item">Reset Password</a>
												</li>
												<li class="slide">
													<a href="{{url('lockscreen')}}" class="side-menu__item">Lockscreen</a>
												</li>
												<li class="slide">
													<a href="{{url('underconstruction')}}" class="side-menu__item">UnderConstruction</a>
												</li>
												<li class="slide">
